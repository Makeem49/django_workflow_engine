    ...
    if department and instance.publish: 
        ...
        if level == 'analyst':
            ...
            * Todo: Send email notifying the supervisor of the department an alert 
            """
            send_email_notification(instance.title, message, instance.user.email, supervisor_email)
            ...
            print('head_of_department_email ********')

            """
            * Todo: Send email notifying the head of department an alert
            """
            send_email_notification(instance.title, message, instance.user.email, head_of_department_email)
            ...
            * Todo: Send email to the cto/cfo of the company an alert 
            """
            send_email_notification(instance.title, message, instance.user.email, cto_or_cfo_email)
            ...
            * Todo: Send email to the company president
            """
            send_email_notification(instance.title, message, instance.user.email, president_email)
            ...
            * Todo: Send email to the CEO of the president
            """                    
            send_email_notification(instance.title, message, instance.user.email, ceo_email)
